...
public class ConfirmLoc extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		btnCancel = (ImageButton)findViewById(R.id.btCancel);
		...
		btnPost = (ImageButton)findViewById(R.id.btPost);
		...
		new AsyncTask<Void, Void, String>()
		{
			...
			protected String doInBackground(Void... params) {
				...
				try
				{
					...
					jsonObject.accumulate("Latitude", 27.2222);
					jsonObject.accumulate("Longitude", 333.3333);
