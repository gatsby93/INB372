...
public final class GeofenceUtils {
    ...
    public static final String EXTRA_CONNECTION_ERROR_CODE =
            "com.example.smartwatch.EXTRA_CONNECTION_ERROR_CODE";

    public static final String EXTRA_CONNECTION_ERROR_MESSAGE =
            "com.example.smartwatch.EXTRA_CONNECTION_ERROR_MESSAGE";

    public static final String EXTRA_GEOFENCE_STATUS =
            "com.example.smartwatch.EXTRA_GEOFENCE_STATUS";

    /*
     * Keys for flattened geofences stored in SharedPreferences
     */
    public static final String KEY_LATITUDE = "com.example.smartwatch.KEY_LATITUDE";

    public static final String KEY_LONGITUDE = "com.example.smartwatch.KEY_LONGITUDE";

    public static final String KEY_RADIUS = "com.example.smartwatch.KEY_RADIUS";

    public static final String KEY_EXPIRATION_DURATION =
            "com.example.smartwatch.KEY_EXPIRATION_DURATION";

    public static final String KEY_TRANSITION_TYPE =
            "com.example.smartwatch.KEY_TRANSITION_TYPE";

    // The prefix for flattened geofence keys
    public static final String KEY_PREFIX =
            "com.example.smartwatch.KEY";
